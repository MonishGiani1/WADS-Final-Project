...
export default function AdminInventoryManagement() {
  ...
  const loadMenuItems = async () => {
    try {
      ...
      const response = await fetch(`${ADMIN_API_BASE}user-backend.up.railway.app/api/admin/menu-items`, {
        method: 'GET',
        headers: {
  ...
  const handleUpdateItem = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${ADMIN_API_BASE}user-backend.up.railway.app/api/admin/menu-items/${editingItem._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleDeleteItem = async (itemId) => {
    ...
    try {
      ...
      const response = await fetch(`${ADMIN_API_BASE}user-backend.up.railway.app/api/admin/menu-items/${itemId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`
        }
  ...
  const handleQuickStockUpdate = async (itemId, newStock) => {
    try {
      ...
      const response = await fetch(`${ADMIN_API_BASE}user-backend.up.railway.app/api/admin/menu-items/${itemId}/stock`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
