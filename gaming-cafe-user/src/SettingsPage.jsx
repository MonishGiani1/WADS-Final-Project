...
export default function SettingsPage() {
    ...
    const loadUserData = async () => {
      try {
        ...
        if (storedUser.id && token) {
          ...
          const response = await fetch(`https://user-backend.up.railway.app/api/users/${storedUser.id}`, {
            headers: {
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      ...
      console.log('Making API call to update profile:', {
        ...
        url: `https://user-backend.up.railway.app/api/users/${storedUser.id}`,
        payload: {
  ...
  const handlePasswordUpdate = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://user-backend.up.railway.app/api/users/${storedUser.id}/password`, {
        method: 'PATCH',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
