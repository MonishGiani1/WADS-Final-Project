...
export default function GameDetailPage({ game, onBack, onLaunch, isLaunching }) {
  ...
  function getScreenshots(gameName) {
    ...
    return [
      `https://user-backend.up.railway.app/api/placeholder/800/450`,
      `https://user-backend.up.railway.app/api/placeholder/800/450`,
      `https://user-backend.up.railway.app/api/placeholder/800/450`,
      `https://user-backend.up.railway.app/api/placeholder/800/450`
    ];
  ...
  const handleLaunch = async () => {
    ...
    try {
      ...
      if (game.executablePath) {
        ...
        const response = await fetch('https://user-backend.up.railway.app/api/launch-game', {
          method: 'POST',
          headers: {
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <img 
          src={game.image || "https://user-backend.up.railway.app/api/placeholder/800/400"} 
          alt={game.name}
